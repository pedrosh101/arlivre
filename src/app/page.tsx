  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center  sm:p-24 p-10 bg-orange-200 text-black sm:text-5xl text-4xl">
        ...
        <div className="p-8 mt-10 sm:w-4/12  text-black text-2xl leading-relaxed hover:text-red-300 italic transition ease-in-out duration-1000 border-2 border-red-300 font-light">
